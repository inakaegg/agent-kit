...
The `pair` skill is also published standalone in English as [pair-watch](https://github.com/inakaegg/pair-watch), installable from its Claude Code plugin marketplace. There the skill body is translated as well.
